...
Anything that crosses a package boundary as a value lives here. Objects that own
state live beside their implementation.
"""
...
class ConfigError(BijouError):
    """A configuration value is missing or two values contradict each other."""


class AdapterError(BijouError):
