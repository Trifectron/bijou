...
from bijou.experiments.console.logs import LogBuffer, LogLine, LogWriter, log_name
from bijou.experiments.console.runner import Runner
from bijou.experiments.console.status import Snapshot, parse_gpus, parse_holders
from bijou.experiments.console.units import Command, Group, Unit, catalog, parse_command
...
def _app(cfg, tmp_path, *scripts: str):
    from bijou.experiments.console.app import ConsoleApp
...
def test_enter_runs_the_selected_unit_and_streams_its_output(cfg, tmp_path):
    ...
    from bijou.experiments.console.app import Status
...
def test_the_command_line_and_search(cfg, tmp_path):
    pytest.importorskip("textual")
    from bijou.experiments.console.app import Mode, Pane, Status
