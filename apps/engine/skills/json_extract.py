...
NAME = "json_extract"
DESCRIPTION = (
    "Turns a sentence describing a person into one JSON object with the keys name, role, city "
    "and years. Use for pulling structured fields about a person out of free text."
)
...
def generate(n: int, seed: int, split: Split = "train") -> list[Sample]:  # noqa: ARG001 - splits differ by seed
