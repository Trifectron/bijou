...
from engine.wiring import Harness, open_harness

Factory = Callable[[Config], AbstractAsyncContextManager[Harness]]
...
def create_app(cfg: Config, factory: Factory = open_harness) -> FastAPI:
