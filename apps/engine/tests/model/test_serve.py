...
from engine.model.local_skills import LocalSkillRuntime  # noqa: E402
from engine.routes.skills import create_app  # noqa: E402
...
async def test_the_bank_runs_in_process_behind_the_same_protocol(bank):
    runtime = LocalSkillRuntime(bank.cfg, bank=bank)
