---
name: adr
description: Write an architecture decision record in docs/decisions/. Use when a change moves a package boundary, forecloses an option, changes the substrate or an experiment's design, or will look arbitrary to someone reading the tree in a year.
---
...
- It moves a boundary between packages, or adds an edge to the dependency rule.
- It changes the base model, an experiment's conditions, or a kill criterion.
